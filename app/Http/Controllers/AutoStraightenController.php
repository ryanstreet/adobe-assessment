...
/**
 * Controller handling incoming /autoStraighten requests.
 *
 * @see routes/web.php
 */
class AutoStraightenController extends Controller
{
    /**
     * @return JsonResponse
     */
    public function __invoke()
    {
        ...
        try {
            ...
            $jobId = $api->postEndpoint(AdobeApi::AUTO_STRAIGHTEN_URL, $body)->getJobId();
            $jsonResponse = [
                'job_id' => $jobId,
